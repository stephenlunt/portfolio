...
function StackIcon({ tech }: StackIconProps) {
  return (
    <li className="flex flex-row flex-nowrap items-center gap-2 bg-zinc-200/30 dark:bg-zinc-900/30 border border-black dark:border-zinc-700 max-w-fit px-2 py-1 my-0 cursor-default">
